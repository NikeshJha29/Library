...
$temp=$row['id'];
      echo "<td><a type='button' class='btn btn-danger' href=\"approval.php?unapprove=$temp>\">Un-Approved</a></button></td>";
    } else {?>
        <td><a type="button" class="btn btn-success" href="approval.php?approve=<?php echo $row['id'];?>">Approved</a></button></td>
      <?php }?>

   <td><a type="button" class="btn btn-info" href="load_file_test.php?pdf=<?php echo $row['name']." ";?>">Open</a></button></td>
